...
<div class="wrapper row2">
  ...
  <div id="container" class="clear">
    <!-- content body -->
		<h2 align="center">View Gate Laptop Register</h2><br><br>
		...
		if(isset($_SESSION['access'])&&($_SESSION['access']=='4'))
		{
			...
			{
						header('location:Gate_settings_admin.php');
			}
...
?>
		<FORM NAME="form2" METHOD="POST" ACTION="view_gate_laptop_admin.php" >
		<table>
		<tr><td>ID: </td><td><INPUT TYPE="TEXT" NAME="id"></td></tr>
		
		<tr><td><INPUT TYPE="SUBMIT" NAME="SUBMIT4" VALUE="View All"></td><td>
		
		<INPUT TYPE="SUBMIT" NAME="SUBMIT3" VALUE="View by ID"></td></tr>
		...
		function view_laptop_gate_entry()
		{
				...
				else
				{
						...
						while($out=mysql_fetch_assoc($result))
						{
							...
							if($exit==NULL)
							{
									echo "<tr><td>$id</td><td>$name</td><td>$entry_date[0]</td><td>$entry_date[1]</td><td>'inside'</td><td>'inside'</td>";
							}
							else
							{
								echo "<tr><td>$id</td><td>$name</td><td>$entry_date[0]</td><td>$entry_date[1]</td><td>$exit_date[0]</td><td>$exit_date[1]</td>";
							}
						}
						echo"</table>";
				}
