...
<nav>
  ...
  <div id="container" class="clear">
    <!-- content body -->
		<section>
		<h2 align="center">Please choose an option:</h2><br><br>
		<a href="View_gate_leave_admin.php">1. View Gate Leave Register</a><br><br>
		<a href="View_gate_leave_after_7_admin.php">2. View Gate Register After 7 pm</a><br><br>
		<a href="View_gate_laptop_admin.php">3. View Gate Laptop Entry</a><br><br>
		</section>
    <!-- main content -->
    <div id="homepage">
