...
<div class="wrapper row2">
  ...
  <div id="container" class="clear">
    <!-- content body -->
		<section>
		<h2 align="center">Register New Admin</h2><br><br>
		<?PHP
...
?>
		...
		<FORM NAME="form2" METHOD="POST" ACTION="Register_new_admin.php" >
		<table>
		<br><br><br>
		...
		<tr><td><INPUT TYPE="SUBMIT" NAME="SUBMIT1" VALUE="REGISTER"></td></tr>
