...
?>
		<br><br>
		<FORM NAME="form2" METHOD="POST" ACTION="Student_entries_doctor.php" >
		<table>
		<tr><td>Resident ID : </td><td><INPUT TYPE="TEXT" NAME="resident_id"></td></tr>
		
		<tr><td>Ailment: </td><td><INPUT TYPE="TEXT"  NAME="ailment"></td></tr>
		
		<tr><td><INPUT TYPE="SUBMIT" NAME="SUBMIT1" VALUE="Insert"></td><td>
