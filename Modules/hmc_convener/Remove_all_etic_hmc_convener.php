...
<div class="wrapper row2">
  ...
  <div id="container" class="clear">
    <!-- content body -->
		...
		<h2 align="center">Remove All ETIC</h2><br><br>
		<?PHP
...
?>
		<br><br>
		Are you sure you want to remove all ETIC registrations?<br>
		<FORM NAME="form2" METHOD="POST" ACTION="Remove_all_etic_hmc_convener.php" >
		<br>
