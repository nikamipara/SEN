...
<div class="wrapper row2">
  ...
  <div id="container" class="clear">
    <!-- content body -->
	<h2 align="center">Lost And Found</h2><br><br>
	<section>
	Please Select an option:<br><br>
	<a href="lf_enter_admin.php">1. Add New Entry<br><br></a>
	<a href="lf_delete_admin.php">2. View/Delete Entry</a><br><br><section>
    <!-- main content -->
    <div id="homepage">
