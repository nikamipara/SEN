...
?></marquee>
  ...
  <div id="container" class="clear">
    <!-- content body -->
		...
		<br><br><br>
		<section>
		<h2>ETIC Scheme</h2><br>
		
				

		About ETIC Scheme:
		The Times of India Newspaper brings the ETIC scheme to the students of DA-IICT.<br><br>
		This scheme entails the students to avail TOI subscription for 3 months at a discounted price.<br><br>

		Students who are interested in availing this scheme can fill out the ETIC scheme registration form.<br><br>
		This form will be displayed to a student only after he/she logs in.<br><br>
		</section>
		</p>
    <!-- main content -->
    <div id="homepage">
